...
void dct_col_inbuf_0::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void dct_col_inbuf_0::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void dct_col_inbuf_0::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void dct_col_inbuf_0::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
