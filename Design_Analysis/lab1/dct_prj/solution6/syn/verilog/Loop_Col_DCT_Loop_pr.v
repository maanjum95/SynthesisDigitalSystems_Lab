...
wire   [0:0] icmp_ln87_fu_313_p2;
wire    ap_CS_fsm_state2;
wire   [3:0] i_fu_319_p2;
reg   [3:0] i_reg_533;
wire   [7:0] zext_ln48_2_fu_345_p1;
reg   [7:0] zext_ln48_2_reg_538;
reg   [2:0] col_inbuf_0_addr_reg_543;
reg   [2:0] col_inbuf_1_addr_reg_548;
reg   [2:0] col_inbuf_2_addr_reg_553;
reg   [2:0] col_inbuf_3_addr_reg_558;
reg   [2:0] col_inbuf_4_addr_reg_563;
reg   [2:0] col_inbuf_5_addr_reg_568;
reg   [2:0] col_inbuf_6_addr_reg_573;
reg   [2:0] col_inbuf_7_addr_reg_578;
...
wire   [7:0] add_ln63_15_fu_377_p2;
reg   [7:0] add_ln63_15_reg_592;
reg   [7:0] add_ln63_15_reg_592_pp0_iter1_reg;
reg   [13:0] dct_coeff_table_0_lo_reg_637;
wire  signed [28:0] mul_ln61_8_fu_471_p2;
reg  signed [28:0] mul_ln61_8_reg_642;
reg  signed [14:0] dct_coeff_table_2_lo_reg_647;
wire  signed [28:0] mul_ln61_10_fu_477_p2;
reg  signed [28:0] mul_ln61_10_reg_652;
reg  signed [14:0] dct_coeff_table_4_lo_reg_657;
wire  signed [28:0] mul_ln61_12_fu_483_p2;
reg  signed [28:0] mul_ln61_12_reg_662;
reg  signed [14:0] dct_coeff_table_6_lo_reg_667;
wire  signed [28:0] grp_fu_489_p3;
reg  signed [28:0] add_ln63_11_reg_672;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg    ap_enable_reg_pp0_iter2;
reg   [3:0] i_2_i_reg_291;
reg    ap_block_state1;
wire    ap_CS_fsm_state6;
wire   [63:0] zext_ln48_fu_325_p1;
wire   [63:0] zext_ln60_fu_361_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln63_2_fu_414_p1;
...
(* use_dsp48 = "no" *) wire   [28:0] add_ln63_9_fu_446_p2;
(* use_dsp48 = "no" *) wire   [28:0] add_ln63_13_fu_450_p2;
wire   [28:0] add_ln63_14_fu_454_p2;
...
dct_mul_mul_15s_16s_29_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 29 ))
dct_mul_mul_15s_16s_29_1_1_U48(
...
dct_mul_mul_15s_16s_29_1_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 29 ))
dct_mul_mul_15s_16s_29_1_1_U49(
...
dct_mul_mul_15s_16s_29_1_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 29 ))
dct_mul_mul_15s_16s_29_1_1_U50(
    .din0(dct_coeff_table_5_q0),
    .din1(col_inbuf_5_q0),
    .dout(mul_ln61_12_fu_483_p2)
);

dct_mac_muladd_15s_16s_14ns_29_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 16 ),
    .din2_WIDTH( 14 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_14ns_29_1_1_U51(
...
dct_mac_muladd_14ns_16s_29s_29_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 14 ),
    .din1_WIDTH( 16 ),
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_14ns_16s_29s_29_1_1_U52(
    .din0(grp_fu_497_p0),
    .din1(col_inbuf_0_q0),
...
dct_mac_muladd_15s_16s_29s_29_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 16 ),
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_29s_29_1_1_U53(
...
dct_mac_muladd_15s_16s_29s_29_1_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_29s_29_1_1_U54(
...
dct_mac_muladd_15s_16s_29s_29_1_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_29s_29_1_1_U55(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln87_fu_313_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln87_fu_313_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln87_fu_313_p2 == 1'd0))) begin
        col_inbuf_0_addr_reg_543 <= zext_ln48_fu_325_p1;
        col_inbuf_1_addr_reg_548 <= zext_ln48_fu_325_p1;
        col_inbuf_2_addr_reg_553 <= zext_ln48_fu_325_p1;
        col_inbuf_3_addr_reg_558 <= zext_ln48_fu_325_p1;
        col_inbuf_4_addr_reg_563 <= zext_ln48_fu_325_p1;
        col_inbuf_5_addr_reg_568 <= zext_ln48_fu_325_p1;
        col_inbuf_6_addr_reg_573 <= zext_ln48_fu_325_p1;
        col_inbuf_7_addr_reg_578 <= zext_ln48_fu_325_p1;
        zext_ln48_2_reg_538[6 : 3] <= zext_ln48_2_fu_345_p1[6 : 3];
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln87_fu_313_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign add_ln63_13_fu_450_p2 = ($signed(grp_fu_513_p3) + $signed(grp_fu_521_p3));

assign add_ln63_14_fu_454_p2 = (add_ln63_9_fu_446_p2 + add_ln63_13_fu_450_p2);

assign add_ln63_15_fu_377_p2 = (zext_ln48_2_reg_538 + zext_ln63_fu_373_p1);

assign add_ln63_9_fu_446_p2 = ($signed(grp_fu_497_p3) + $signed(grp_fu_505_p3));
...
assign col_inbuf_0_address0 = col_inbuf_0_addr_reg_543;

assign col_inbuf_1_address0 = col_inbuf_1_addr_reg_548;

assign col_inbuf_2_address0 = col_inbuf_2_addr_reg_553;

assign col_inbuf_3_address0 = col_inbuf_3_addr_reg_558;

assign col_inbuf_4_address0 = col_inbuf_4_addr_reg_563;

assign col_inbuf_5_address0 = col_inbuf_5_addr_reg_568;

assign col_inbuf_6_address0 = col_inbuf_6_addr_reg_573;

assign col_inbuf_7_address0 = col_inbuf_7_addr_reg_578;

assign col_outbuf_i_address0 = zext_ln63_2_fu_414_p1;

assign col_outbuf_i_d0 = {{add_ln63_14_fu_454_p2[28:13]}};
...
assign i_fu_319_p2 = (i_2_i_reg_291 + 4'd1);

assign icmp_ln55_fu_349_p2 = ((k_0_i_reg_302 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln87_fu_313_p2 = ((i_2_i_reg_291 == 4'd8) ? 1'b1 : 1'b0);

assign k_fu_355_p2 = (k_0_i_reg_302 + 4'd1);

assign tmp_fu_337_p3 = {{i_2_i_reg_291}, {3'd0}};

assign zext_ln48_2_fu_345_p1 = tmp_fu_337_p3;

assign zext_ln48_fu_325_p1 = i_2_i_reg_291;

assign zext_ln60_fu_361_p1 = k_0_i_reg_302;

assign zext_ln63_2_fu_414_p1 = add_ln63_15_reg_592_pp0_iter1_reg;

assign zext_ln63_fu_373_p1 = k_0_i_reg_302;

always @ (posedge ap_clk) begin
    zext_ln48_2_reg_538[2:0] <= 3'b000;
    zext_ln48_2_reg_538[7] <= 1'b0;
end
