...
export EDADUINO_TCPPORT=$(grep -Eo "\b[0-9]+\b" $SDS_LAB/$TUMID/lab1_helloworld/edaduino/vp/ini/remote.ini)

# Add precompiled shared libraries to LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$ETISS_HOME/lib
...
alias edaduino-sdk="$SDS_TOOLS/sdk/eclipse/eclipse"
