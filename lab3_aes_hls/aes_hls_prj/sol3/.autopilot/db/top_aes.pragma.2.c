...
void aes16_bidir(uint32_t key[4], uint32_t inout[4], uint32_t iv[4]){_ssdm_SpecArrayDimSize(key, 4);_ssdm_SpecArrayDimSize(inout, 4);_ssdm_SpecArrayDimSize(iv, 4);

_ssdm_SpecArrayPartition( inout, 1, "COMPLETE", 0, "");
_ssdm_SpecArrayPartition( key, 1, "COMPLETE", 0, "");
_ssdm_SpecArrayPartition( iv, 1, "COMPLETE", 0, "");
