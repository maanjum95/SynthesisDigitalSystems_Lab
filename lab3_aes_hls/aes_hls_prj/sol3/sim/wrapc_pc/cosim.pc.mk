...
AUTOPILOT_ROOT := /nfs/tools/xilinx/Vivado/2019.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /nfs/tools/xilinx/Vivado/2019.1/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/aes_test.c_pre.c.tb.o : aes_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) aes_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/top_aes.c_pre.c.tb.o : top_aes.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) top_aes.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
