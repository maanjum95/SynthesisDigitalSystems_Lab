...
architecture behav of dct_1d2 is 
    ...
    component dct_mac_muladd_15s_16s_32ns_32_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dct_1d2_dct_coeff_table IS
    generic (
        DataWidth : INTEGER;
...
begin
    dct_coeff_table_U : component dct_1d2_dct_coeff_table
    generic map (
        DataWidth => 15,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    dct_mac_muladd_15s_16s_32ns_32_1_1_U1 : component dct_mac_muladd_15s_16s_32ns_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 15,
