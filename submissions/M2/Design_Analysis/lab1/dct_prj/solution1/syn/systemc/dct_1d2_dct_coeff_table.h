...
// ==============================================================
#ifndef __dct_1d2_dct_coeff_table_H__
#define __dct_1d2_dct_coeff_table_H__
...
struct dct_1d2_dct_coeff_table_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dct_1d2_dct_coeff_table_ram) {
...
SC_MODULE(dct_1d2_dct_coeff_table) {
...
dct_1d2_dct_coeff_table_ram* meminst;


SC_CTOR(dct_1d2_dct_coeff_table) {
meminst = new dct_1d2_dct_coeff_table_ram("dct_1d2_dct_coeff_table_ram");
