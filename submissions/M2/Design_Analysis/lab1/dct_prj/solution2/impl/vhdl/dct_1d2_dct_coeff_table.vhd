...
entity dct_1d2_dct_coeff_table_rom is 
    generic(
             DWIDTH     : integer := 15; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of dct_1d2_dct_coeff_table_rom is 
...
entity dct_1d2_dct_coeff_table is
    generic (
...
architecture arch of dct_1d2_dct_coeff_table is
    component dct_1d2_dct_coeff_table_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dct_1d2_dct_coeff_table_rom_U :  component dct_1d2_dct_coeff_table_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
