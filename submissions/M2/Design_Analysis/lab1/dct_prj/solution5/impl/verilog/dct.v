...
(* CORE_GENERATION_INFO="dct,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-1-e,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.904187,HLS_SYN_LAT=476,HLS_SYN_TPT=343,HLS_SYN_MEM=3,HLS_SYN_DSP=8,HLS_SYN_FF=1009,HLS_SYN_LUT=1654,HLS_VERSION=2019_1}" *)
