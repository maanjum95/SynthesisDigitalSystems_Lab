...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_icmp_ln61_fu_144_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_fu_136_p3 );
    sensitive << ( i_0_reg_104 );

    SC_METHOD(thread_mul_ln68_fu_163_p0);
    sensitive << ( c_q0 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_mul_ln68_fu_163_p2);
    sensitive << ( data_0_reg_116 );
    sensitive << ( mul_ln68_fu_163_p0 );

    SC_METHOD(thread_sext_ln60_fu_132_p1);
    sensitive << ( i_0_reg_104 );

    SC_METHOD(thread_shift_reg_address0);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( icmp_ln61_fu_144_p2 );
    sensitive << ( tmp_fu_136_p3 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( zext_ln65_fu_150_p1 );
    sensitive << ( zext_ln65_1_fu_155_p1 );
    ...
    SC_METHOD(thread_zext_ln65_1_fu_155_p1);
    sensitive << ( sext_ln60_reg_181 );

    SC_METHOD(thread_zext_ln65_fu_150_p1);
    sensitive << ( grp_fu_125_p2 );

    SC_METHOD(thread_zext_ln68_fu_159_p1);
    sensitive << ( sext_ln60_reg_181 );
    ...
    sc_trace(mVcdFile, sext_ln60_fu_132_p1, "sext_ln60_fu_132_p1");
    sc_trace(mVcdFile, sext_ln60_reg_181, "sext_ln60_reg_181");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, icmp_ln61_fu_144_p2, "icmp_ln61_fu_144_p2");
    sc_trace(mVcdFile, icmp_ln61_reg_190, "icmp_ln61_reg_190");
    ...
    sc_trace(mVcdFile, zext_ln65_fu_150_p1, "zext_ln65_fu_150_p1");
    sc_trace(mVcdFile, zext_ln65_1_fu_155_p1, "zext_ln65_1_fu_155_p1");
    sc_trace(mVcdFile, zext_ln68_fu_159_p1, "zext_ln68_fu_159_p1");
    sc_trace(mVcdFile, grp_fu_125_p0, "grp_fu_125_p0");
    sc_trace(mVcdFile, mul_ln68_fu_163_p0, "mul_ln68_fu_163_p0");
    sc_trace(mVcdFile, mul_ln68_fu_163_p2, "mul_ln68_fu_163_p2");
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(icmp_ln61_reg_190.read(), ap_const_lv1_0))) {
        data_0_reg_116 = shift_reg_q0.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln61_fu_144_p2.read(), ap_const_lv1_1))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0))) {
        icmp_ln61_reg_190 = icmp_ln61_fu_144_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        sext_ln60_reg_181 = sext_ln60_fu_132_p1.read();
    }
}

void fir::thread_acc_fu_169_p2() {
    acc_fu_169_p2 = (!mul_ln68_fu_163_p2.read().is_01() || !acc_0_reg_91.read().is_01())? sc_lv<32>(): (sc_biguint<32>(mul_ln68_fu_163_p2.read()) + sc_biguint<32>(acc_0_reg_91.read()));
}
...
void fir::thread_c_address0() {
    c_address0 =  (sc_lv<4>) (zext_ln68_fu_159_p1.read());
}
...
void fir::thread_icmp_ln61_fu_144_p2() {
    icmp_ln61_fu_144_p2 = (!i_0_reg_104.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_104.read() == ap_const_lv5_0);
}

void fir::thread_mul_ln68_fu_163_p0() {
    mul_ln68_fu_163_p0 = c_q0.read();
}

void fir::thread_mul_ln68_fu_163_p2() {
    mul_ln68_fu_163_p2 = (!mul_ln68_fu_163_p0.read().is_01() || !data_0_reg_116.read().is_01())? sc_lv<32>(): sc_bigint<32>(mul_ln68_fu_163_p0.read()) * sc_bigint<32>(data_0_reg_116.read());
}

void fir::thread_sext_ln60_fu_132_p1() {
    sext_ln60_fu_132_p1 = esl_sext<32,5>(i_0_reg_104.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln65_1_fu_155_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln61_fu_144_p2.read(), ap_const_lv1_1))) {
        shift_reg_address0 = ap_const_lv4_0;
                ...
                esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln61_fu_144_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln65_fu_150_p1.read());
    } else {
...
void fir::thread_tmp_fu_136_p3() {
    tmp_fu_136_p3 = i_0_reg_104.read().range(4, 4);
}
...
void fir::thread_zext_ln65_1_fu_155_p1() {
    zext_ln65_1_fu_155_p1 = esl_zext<64,32>(sext_ln60_reg_181.read());
}

void fir::thread_zext_ln65_fu_150_p1() {
    zext_ln65_fu_150_p1 = esl_zext<64,5>(grp_fu_125_p2.read());
}

void fir::thread_zext_ln68_fu_159_p1() {
    zext_ln68_fu_159_p1 = esl_zext<64,32>(sext_ln60_reg_181.read());
}
