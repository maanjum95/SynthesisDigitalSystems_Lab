...
set ID 10
set hasByteEnable 0
set MemName AES_CTR_xcrypt_buffe_buffer
...
set ID 11
set hasByteEnable 0
set MemName AES_CTR_xcrypt_buffe_x
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 16
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename ctx_Iv \
    op interface \
    ports { ctx_Iv_address0 { O 4 vector } ctx_Iv_ce0 { O 1 bit } ctx_Iv_we0 { O 1 bit } ctx_Iv_d0 { O 8 vector } ctx_Iv_q0 { I 8 vector } } \
} "
} else {
