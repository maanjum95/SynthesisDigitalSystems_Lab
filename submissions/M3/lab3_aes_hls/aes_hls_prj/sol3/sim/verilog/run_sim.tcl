...
if {[file isfile aes16_bidir.autotvin.dat]} {
	file delete -force aes16_bidir.autotvin.dat
}

if {[file isfile aes16_bidir.autotvout.dat]} {
	file delete -force aes16_bidir.autotvout.dat
}
