...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado/2019.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado/2019.1/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado/2019.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado/2019.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado/2019.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "aes16_bidir.autotvin.dat"
	set constFileTvOut       "aes16_bidir.autotvout.dat"
	set constFileHdlTvIn     "aes16_bidir.autohdltvin.dat"
	set constFileHdlTvOut    "aes16_bidir.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
